...
<<<<<<< HEAD
    ...
    DEF_TIM(TIM1, CH2N, PB0, TIM_USE_MOTOR,               TIMER_OUTPUT_ENABLED, 1 ), // S3_OUT DMA2_ST6 DMA2_ST2
    ...
    DEF_TIM(TIM1, CH3N, PB1, TIM_USE_MOTOR,               TIMER_OUTPUT_ENABLED, 0 ), // S8_OUT DMA2_ST6
