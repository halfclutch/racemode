...
<<<<<<< HEAD
    ...
    DEF_TIM(TIM3,  CH3, PB0,   TIM_USE_MOTOR, 1,  0),    // M1 , DMA1_ST7
    DEF_TIM(TIM3,  CH4, PB1,   TIM_USE_MOTOR, 1,  0),    // M2 , DMA1_ST2
    DEF_TIM(TIM1,  CH1, PE9,   TIM_USE_MOTOR, 1,  2),    // M3 , DMA2_ST2
    DEF_TIM(TIM1,  CH2, PE11,  TIM_USE_MOTOR, 1,  1),    // M4 , DMA2_ST4
    DEF_TIM(TIM8,  CH4, PC9,   TIM_USE_MOTOR, 1,  0),    // M5 , DMA2_ST7
    DEF_TIM(TIM5,  CH4, PA3,   TIM_USE_MOTOR, 1,  0),    // M6 , DMA1_ST1
    
    DEF_TIM(TIM4,  CH1, PD12,  TIM_USE_LED,   1,  0),    // LED_TRIP , DMA1_ST0
=======
    DEF_TIM(TIM1, CH3, PE13, TIM_USE_PPM,   0, 1), // PPM , DMA2_ST6
