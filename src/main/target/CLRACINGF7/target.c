...
<<<<<<< HEAD
    DEF_TIM(TIM10, CH1, PB8,  TIM_USE_ANY,                 TIMER_OUTPUT_ENABLED,  0), // USE FOR CAMERA CONTROL
    ...
    DEF_TIM(TIM1,  CH3N, PB1,  TIM_USE_MOTOR | TIM_USE_LED, TIMER_OUTPUT_ENABLED, 0), // S5_OUT - DMA2_ST6  D(2, 6, 0),D(2, 6, 6)
=======
